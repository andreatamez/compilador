...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 49; i <= 57; ++i) start[i] = 11;
		for (int i = 65; i <= 90; ++i) start[i] = 8;
		for (int i = 97; i <= 108; ++i) start[i] = 8;
		for (int i = 110; i <= 122; ++i) start[i] = 8;
		start[48] = 12; 
		start[45] = 38; 
		start[46] = 39; 
		start[39] = 5; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 1:
				if (ch >= '1' && ch <= '9') {AddCh(); goto case 2;}
				else if (ch == '0') {AddCh(); goto case 4;}
				else {goto case 0;}
			case 2:
			...
			case 13:
				recEnd = pos; recKind = 2;
				if (ch >= '1' && ch <= '9') {AddCh(); goto case 3;}
				else if (ch == '0') {AddCh(); goto case 4;}
				else {t.kind = 2; break;}
			case 14:
				recEnd = pos; recKind = 2;
			...
			case 38:
				...
				if (ch >= '1' && ch <= '9') {AddCh(); goto case 11;}
				else if (ch == '0') {AddCh(); goto case 15;}
			...
			case 40:
				recEnd = pos; recKind = 4;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'b' && ch <= 'z') {AddCh(); goto case 8;}
			...
			case 44:
				recEnd = pos; recKind = 4;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == 'i') {AddCh(); goto case 45;}
				else {t.kind = 4; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 45:
				recEnd = pos; recKind = 4;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); goto case 8;}
				else if (ch == 'n') {AddCh(); goto case 46;}
				else {t.kind = 4; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 46:
				recEnd = pos; recKind = 4;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 8;}
